...
`POST /ocm/invite-accepted` is an OCM Provider endpoint ([Invite Flow](https://github.com/cs3org/OCM-API/blob/a2b8bacd4590ff201a06883330b67636e99c4f5b/IETF-RFC.md?plain=1#invite-flow)).
