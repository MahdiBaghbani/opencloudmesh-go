...
// bannedLegacyTestHelperImports are removed helper roots that must not reappear.
...
// TestTestsupportOnlyImportedFromTestFiles enforces that packages under
// internal/testsupport are only imported from _test.go files outside that tree.
...
// TestNoLegacyTestHelperImportPaths bans resurrection of removed helper package paths.
