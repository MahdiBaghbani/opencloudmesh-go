...
func TestNew_FailsWithNilDeps(t *testing.T) {
	...
	_, err := New(cfg, logger, nil, nil, nil, nil, nil, nil) // nil services acceptable for tests
	if err == nil {
...
func TestNew_FailsWithMissingPartyRepo(t *testing.T) {
	...
	_, err := New(cfg, logger, deps, nil, nil, nil, nil, nil) // nil services acceptable for tests
	if err == nil {
...
func TestNew_FailsWithMissingSessionRepo(t *testing.T) {
	...
	_, err := New(cfg, logger, deps, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestNew_SucceedsWithRequiredDeps(t *testing.T) {
	...
	srv, err := New(cfg, logger, deps, nil, nil, nil, nil, nil) // nil services acceptable for tests
	if err != nil {
